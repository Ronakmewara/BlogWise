  ...
  return (
    <div className=' max-w-[100vw] w-full h-[60vh] lg:h-[70vh]' >
      <div className="heading text-center ">
        <h1 className=' text-4xl  md:text-6xl text-white mb-12 font-bold inter mt-20 md:mt-44 bg-gradient-to-r from-white/10 to-white bg-clip-text text-transparent '>
