...
<div  className=" max-w-[300px] lg:max-w-[340px] max-h-[500px] btn-grad1 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div  className="p-5">
            ...
            <h5  className="mb-2 max-w-full  text-xl md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{post.title}</h5>
        
        <div  className="mb-3  limited font-normal w-full h-12   text-gray-700 dark:text-gray-400">{parse(post.content)}</div>
